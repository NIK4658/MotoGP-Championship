...
public class CampionatoCostruttori extends JPanel{

    public CampionatoCostruttori(final Dimension dim, final DBConnection con) {
        String[] fields = {"Campionato"};
        ...
        //title
        JLabel title = new JLabel("COSTRUTTORI", SwingConstants.CENTER);
        ...
        westPanel.add(register, new MyGridBagConstraints(0, 4, new Insets(0,0,0,0), GridBagConstraints.CENTER));
        ...
        register.addActionListener((e) -> {
            ...
            if(champ.length()>0){
                JTabbedPane table = con.getCampionatoCostruttori(dim, champ);
