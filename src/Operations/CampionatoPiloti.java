...
public class CampionatoPiloti extends JPanel{

    public CampionatoPiloti(final Dimension dim, final DBConnection con) {
        ...
        register.addActionListener((e) -> {
            ...
            if(champ.length()>0){
                JTabbedPane table = con.getCampionatoPiloti(dim, champ);
