...
public class RegisterConstructor extends JPanel{

    public RegisterConstructor(final Dimension dim, final DBConnection con) {
        String[] fields = {"Nome", "TipoMotore"};
        ...
        //title
        JLabel title = new JLabel("Registrazione COSTRUTTORI");
        title.setFont(new Font("Arial", Font.BOLD, dim.width / 15));
        title.setForeground(Color.BLACK);
        northPanel.add(title);
        //Main label wih text
        JLabel text = new JLabel("Perfavore riempi i campi sottostanti per registrare un nuovo COSTRUTTORE", JLabel.CENTER);
