...
public class RegisterTeam extends JPanel{

    public RegisterTeam(final Dimension dim, final DBConnection con) {
        String[] fields = {"Nome"};
        ...
        //title
        JLabel title = new JLabel("Registrazione TEAM");
        title.setFont(new Font("Arial", Font.BOLD, dim.width / 15));
        title.setForeground(Color.BLACK);
        northPanel.add(title);
        //Main label wih text
        JLabel text = new JLabel("Perfavore riempi il campo sottostanti per registrare un nuovo TEAM", JLabel.CENTER);
